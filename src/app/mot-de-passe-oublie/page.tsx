...
if (err.status === 404) setError("Aucun compte associé à cet email.");
...
background: error ? "rgba(239,68,68,0.08)" : "rgba(255,255,255,0.08)",
border: error ? "1px solid rgba(239,68,68,0.4)" : "1px solid rgba(255,255,255,0.12)",
borderRadius: "0.75rem", color: "#FAF7F2",
fontSize: "0.9rem", outline: "none", fontFamily: "inherit",
}}
/>
{error && <p style={{ color: "#fca5a5", fontSize: "0.75rem", marginTop: "0.35rem" }}>⚠️ {error}</p>}
</div>
...
<div style={{ background: "rgba(34,197,94,0.12)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: "0.75rem", padding: "1.25rem", textAlign: "left" }}>
<p style={{ color: "#86efac", fontWeight: 600, marginBottom: "0.5rem" }}>✅ Email de réinitialisation envoyé !</p>
