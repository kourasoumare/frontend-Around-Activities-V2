  ...
  <span style={{
    ...
    color: "transparent",
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            <div>
              <label style={{ display: "block", fontSize: "0.75rem", fontWeight: 600, color: "rgba(250,247,242,0.6)", marginBottom: "0.5rem", letterSpacing: "0.05em" }}>EMAIL</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label style={{ display: "block", fontSize: "0.75rem", fontWeight: 600, color: "rgba(250,247,242,0.6)", marginBottom: "0.5rem", letterSpacing: "0.05em" }}>MOT DE PASSE</label>
              <input
                type="password"
                name="password"
                placeholder="••••••••"
