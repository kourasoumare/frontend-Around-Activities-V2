  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0 relative" style={{ background: "#2D1535" }}>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        <div
          className="absolute gradient-animated"
          style={{
            width: "60%",
            height: "60%",
            top: "0%",
            left: "0%",
            background: "radial-gradient(ellipse, rgba(196,96,58,0.20) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute gradient-animated"
          style={{
            ...
            bottom: "0%",
            right: "0%",
            background: "radial-gradient(ellipse, rgba(160,60,180,0.15) 0%, transparent 70%)",
            animationDelay: "-4s",
          }}
        />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-2xl mx-auto px-6 py-10">
          ...
          <h1
            className="font-head font-black tracking-tight mb-1"
            style={{ fontSize: "2rem", color: "#FAF7F2" }}
          >
            Modifier mon{" "}
            <span
              style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            >
              <h2 style={{ fontWeight: 600, color: "#FAF7F2", marginBottom: "1.25rem" }}>
                ...
                <div>
                  ...
                  >
                    {["Paris", "Lyon", "Bordeaux", "Marseille", "Toulouse", "Nantes", "Lille"].map((c) => (
                      <option key={c} value={c} style={{ background: "#2D1535" }}>
                        {c}
                      </option>
                    ))}
                  </select>
