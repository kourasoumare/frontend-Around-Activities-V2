...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0 relative" style={{ background: "var(--bg)" }}>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        <div
          ...
          style={{
            width: "60%", height: "60%",
            top: "0%", left: "0%",
            background: "radial-gradient(ellipse, rgba(196,96,58,0.12) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute gradient-animated"
          style={{
            width: "60%", height: "60%",
            top: "30%", left: "20%",
            background: "radial-gradient(ellipse, rgba(196,96,58,0.10) 0%, transparent 70%)",
            animationDelay: "-3s",
          }}
        />
        <div
          ...
          style={{
            width: "60%", height: "60%",
            top: "10%", right: "0%",
            background: "radial-gradient(ellipse, rgba(196,96,58,0.25) 0%, transparent 70%)",
            animationDelay: "-5s",
          }}
        />
      </div>
